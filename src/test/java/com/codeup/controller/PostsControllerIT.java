...
import com.codeup.utils.HsqldbSequenceResetter;
...
public class PostsControllerIT extends AbstractIntegrationTest {
    ...
    public void shouldShowCommentFormWhenAuthorized() throws Exception {
        mockMvc.perform(get("/posts/1").with(SecurityUtils.userBob()))
                .andExpect(status().isOk())
                .andExpect(view().name("post"))
    ...
    public void shouldShowCreatePostPageIfAdmin() throws Exception {
        mockMvc.perform(get("/posts/create").with(SecurityUtils.userAdmin()))
                .andExpect(status().isOk())
    ...
    public void shouldDenyCreatePostIfNotAdmin() throws Exception {
        ...
        mockMvc.perform(get("/posts/create").with(SecurityUtils.userBob()))
                .andExpect(status().isForbidden());

        mockMvc.perform(post("/posts/create").with(SecurityUtils.userBob()).with(csrf()))
                .andExpect(status().isForbidden());
    }
    ...
    public void shouldReturnAddPostFormWithErrorsWhenSubmittedInvalidPost() throws Exception {
        mockMvc.perform(post("/posts/create").with(SecurityUtils.userAdmin()).with(csrf())
    ...
    public void shouldShowEditPostPageIfAdmin() throws Exception {
        mockMvc.perform(get("/posts/1/edit").with(SecurityUtils.userAdmin()))
                .andExpect(status().isOk())
                .andExpect(view().name("editpost"))
    ...
    public void shouldDenyEditPostIfNotAdmin() throws Exception {
        ...
        mockMvc.perform(get("/posts/1/edit").with(SecurityUtils.userBob()))
                .andExpect(status().isForbidden());

        mockMvc.perform(post("/posts/1/edit").with(SecurityUtils.userBob()).with(csrf()))
                .andExpect(status().isForbidden());
    }
    ...
    public void shouldReturnEditPostFormWithErrorsWhenSubmittedInvalidPost() throws Exception {
        mockMvc.perform(post("/posts/1/edit").with(SecurityUtils.userAdmin()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED))
                .andExpect(status().isOk())
                .andExpect(model().attributeHasFieldErrors("post", "title"))
                .andExpect(model().attributeHasFieldErrors("post", "text"))
    ...
    public void shouldEditPosts() throws Exception {
        ...
        mockMvc.perform(post("/posts/2/edit").with(SecurityUtils.userAdmin()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                .param("title", title)
                .param("text", text2)
                .param("tags", tags2))
    ...
    public void shouldDenyHidePostIfNotAdmin() throws Exception {
        ...
        mockMvc.perform(post("/posts/1/hide").with(SecurityUtils.userBob()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED))
                .andExpect(status().isForbidden());
    }
    ...
    public void shouldDenyUnhidePostIfNotAdmin() throws Exception {
        ...
        mockMvc.perform(post("/posts/1/unhide").with(SecurityUtils.userBob()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED))
                .andExpect(status().isForbidden());
    }
    ...
    public void shouldHidePost() throws Exception {
        mockMvc.perform(post("/posts/1/hide").with(SecurityUtils.userAdmin()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(get("/posts/1").with(SecurityUtils.userAdmin()))
                .andExpect(status().isOk());
    }
    ...
    public void shouldUnhidePost() throws Exception {
        mockMvc.perform(post("/posts/1/unhide").with(SecurityUtils.userAdmin()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED))
                .andExpect(status().isOk())
                .andExpect(content().string("ok"));
    }
    ...
    public void shouldNotShowHiddenPostIfNotAdmin() throws Exception {
        mockMvc.perform(get("/").with(SecurityUtils.userBob()))
                .andExpect(status().isOk())
                .andExpect(view().name("posts"))
    ...
    public void shouldShowHiddenPostIfAdmin() throws Exception {
        mockMvc.perform(get("/").with(SecurityUtils.userAdmin()))
                .andExpect(status().isOk())
                .andExpect(view().name("posts"))
                .andExpect(model().attribute("postsPage", hasProperty("totalElements", equalTo(2L))));
    }
    ...
    public void shouldDenyDeletePostIfNotAdmin() throws Exception {
        ...
        mockMvc.perform(post("/posts/1/delete").with(SecurityUtils.userBob()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED))
                .andExpect(status().isForbidden());
    }
    ...
    public void shouldDeletePost() throws Exception {
        mockMvc.perform(post("/posts/1/delete").with(SecurityUtils.userAdmin()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED))
                .andExpect(status().isOk())
                .andExpect(content().string("ok"));
    }
    ...
    public void shouldShowHiddenPostsByTagIfAdmin() throws Exception {
        mockMvc.perform(get("/posts?tagged=c++").with(SecurityUtils.userAdmin()))
                .andExpect(status().isOk())
                .andExpect(view().name("posts"))
                .andExpect(model().attribute("postsPage", hasProperty("totalElements", equalTo(2L))));
    }
    ...
    public void shouldVote() throws Exception {
        mockMvc.perform(post("/posts/1/like").with(SecurityUtils.userBob()).with(csrf()))
                .andExpect(status().isOk())
                .andExpect(content().string("ok"));

        mockMvc.perform(post("/posts/2/dislike").with(SecurityUtils.userBob()).with(csrf()))
                .andExpect(status().isOk())
                .andExpect(content().string("ok"));
    }
    ...
    public void shouldDenyVoteMoreThanOnce() throws Exception {
        mockMvc.perform(post("/posts/1/like").with(SecurityUtils.userAlice()).with(csrf()))
                .andExpect(status().isOk())
                .andExpect(content().string("already_voted"));

        mockMvc.perform(post("/posts/1/dislike").with(SecurityUtils.userAlice()).with(csrf()))
                .andExpect(status().isOk())
                .andExpect(content().string("already_voted"));
    }
}