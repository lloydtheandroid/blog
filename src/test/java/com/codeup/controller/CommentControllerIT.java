...
import com.codeup.service.CommentService;
...
public class CommentControllerIT extends AbstractIntegrationTest {
    ...
    public void shouldReturn404WhenPostIsHidden() throws Exception {
        ...
        mockMvc.perform(get("/posts/1/comments").with(SecurityUtils.userBob()))
                .andExpect(status().isNotFound());
    }
    ...
    public void shouldShowCommentsWhenPostIsHiddenAndAdmin() throws Exception {
        mockMvc.perform(get("/posts/1/comments").with(SecurityUtils.userAdmin()))
                .andExpect(status().isOk());
    }
    ...
    public void shouldGetCommentSource() throws Exception {
        mockMvc.perform(get("/posts/1/comments/3/source").with(SecurityUtils.userBob()))
                .andExpect(status().isOk())
    ...
    public void shouldReturnErrorWhenSubmittedInvalidComment() throws Exception {
        mockMvc.perform(post("/posts/1/comments/create").with(SecurityUtils.userBob()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                .param("commentText", ""))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.status", is("error")));

        mockMvc.perform(post("/posts/999/comments/create").with(SecurityUtils.userBob()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
    ...
    public void shouldDenyDeleteOtherUserComment() throws Exception {
        mockMvc.perform(post("/posts/1/comments/3/delete").with(SecurityUtils.userBob()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED))
    ...
    public void shouldDenyDeleteCommentIfExpired() throws Exception {
        mockMvc.perform(post("/posts/1/comments/3/delete").with(SecurityUtils.userAlice()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED))
                .andExpect(status().isOk())
    ...
    public void shouldDeleteComment() throws Exception {
        ...
        mockMvc.perform(post("/posts/1/comments/4/delete").with(SecurityUtils.userBob()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED))
                .andExpect(status().isOk())
    ...
    public void shouldAllowDeleteAnyCommentIfAdmin() throws Exception {
        mockMvc.perform(post("/posts/1/comments/3/delete").with(SecurityUtils.userAdmin()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED))
                .andExpect(status().isOk())
                .andExpect(content().string("ok"));
    }
    ...
    public void shouldDenyEditOtherUserComment() throws Exception {
        mockMvc.perform(post("/posts/1/comments/3/edit").with(SecurityUtils.userBob()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                .param("commentText", "new comment text"))
                .andExpect(status().isForbidden());
    }
    ...
    public void shouldDenyEditCommentIfExpired() throws Exception {
        mockMvc.perform(post("/posts/1/comments/3/edit").with(SecurityUtils.userAlice()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                .param("commentText", "new comment text"))
                .andExpect(status().isOk())
                .andExpect(content().string("expired"));
    ...
    public void shouldReturnErrorWhenSubmittedInvalidEditComment() throws Exception {
        mockMvc.perform(post("/posts/1/comments/3/edit").with(SecurityUtils.userAdmin()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED))
                .andExpect(status().isOk())
    ...
    public void shouldEditComment() throws Exception {
        ...
        mockMvc.perform(post("/posts/1/comments/4/edit").with(SecurityUtils.userBob()).with(csrf())
                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                .param("commentText", text))
                .andExpect(status().isOk())
                .andExpect(content().string("ok"));
    ...
    public void shouldVote() throws Exception {
        mockMvc.perform(post("/posts/1/comments/1/like").with(SecurityUtils.userBob()).with(csrf()))
                .andExpect(status().isOk())
                .andExpect(content().string("ok"));

        mockMvc.perform(post("/posts/1/comments/2/dislike").with(SecurityUtils.userBob()).with(csrf()))
                .andExpect(status().isOk())
                .andExpect(content().string("ok"));
    }
    ...
    public void shouldDenyVoteMoreThanOnce() throws Exception {
        mockMvc.perform(post("/posts/1/comments/2/like").with(SecurityUtils.userAlice()).with(csrf()))
                .andExpect(status().isOk())
                .andExpect(content().string("already_voted"));

        mockMvc.perform(post("/posts/1/comments/2/dislike").with(SecurityUtils.userAlice()).with(csrf()))
                .andExpect(status().isOk())
                .andExpect(content().string("already_voted"));
    }
    ...
    public void shouldDenyVoteForOwnComment() throws Exception {
        mockMvc.perform(post("/posts/1/comments/2/like").with(SecurityUtils.userAdmin()).with(csrf()))
                .andExpect(status().isOk())
